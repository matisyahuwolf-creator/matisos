...
// The launcher IS the painted scene (public/workshop-backdrop.png, 1448x1086).
// Nothing is rendered on top except invisible click hotspots over each
// painted hanging sign — so the page looks pixel-for-pixel like the mockup.
//
// Tradeoffs of pixel-perfect mode:
// - Date plaque, weather, suggestion cards, search box are PAINTED, not live.
// - Only the 7 apps in the painted backdrop are reachable from here.
//   New apps (Renaissance, Cadence) are skipped; to add them, regenerate
//   the backdrop with more painted tiles.
